...
### Installing
  ...
  <dl>
  <dt>Windows</dt>
  <dd>You can use this software in windows by simply installing the installer package. The installer package you can get from the following link:<br><a href="https://sourceforge.net/projects/typingguru/">Typing Guru</a><br>
  ...
  <dt>Linux</dt>
  <dd>You can use this software in Linux by simply extracting the source file and double-clicking on the executable file named as TypingGuru. You can get the source from the following link:<br><a href="https://sourceforge.net/projects/typingguru/">Typing Guru</a><br>
  </dd>
  ...
  <dd>
    ...
    <a href="https://sourceforge.net/projects/typingguru/">TypingGuru Jar file</a>
    </dd>
</dl>
