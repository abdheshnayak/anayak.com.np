...
layout: blog-post
type: project-toedit
title: Static Page Views Counter
subtitle: A simple way to implement views/visits counter on your website.
description: A simple way to implement views/visits counter on your website.
image: https://img.shields.io/endpoint?url=https://kamla.com.np/vcnt/?IDV=testpage
sortdescp: It is an easy way to put total views counter on your website. Just add one line of the image tag in your site, you are all set.
---
...
You can also change label color by adding %26%26CLABEL=colorname
